...
st.markdown(
    ...
    <style>
    .stAppViewContainer {{
        background-image: url('https://static.timesofisrael.com/www/uploads/2020/08/iStock-1156928054.jpg');
...
# st.image("img1.jpg")
# st.image("https://static.timesofisrael.com/www/uploads/2020/08/iStock-1156928054.jpg")
...
sex_encoded =Sex.transform([sexb])
...
data=pd.DataFrame({'Sex':sex_encoded,
                   'AgeCategory':ageb,
